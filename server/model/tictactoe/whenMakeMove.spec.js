...
describe('when make move', () => {
	...
	describe ('drawing scenarios', () => {
		...
		it ('a different full board without victory should also be a draw', () => {
			given = given.concat([{
				id:        '1720',
				event:     'MoveMade',
				userName:  'jobbi',
